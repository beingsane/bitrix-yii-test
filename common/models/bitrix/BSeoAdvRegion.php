...
/**
 * This is the model class for table "b_seo_adv_region".
 *
 * @property integer $ID
 ...
 */
class BSeoAdvRegion extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['ENGINE_ID', 'OWNER_ID', 'OWNER_NAME', 'XML_ID', 'NAME', 'PARENT_ID'], 'required'],
            [['ENGINE_ID', 'PARENT_ID'], 'integer'],
            [['LAST_UPDATE'], 'safe'],
            [['SETTINGS'], 'string'],
