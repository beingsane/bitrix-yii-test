...
/**
 * This is the model class for table "b_iblock_element_right".
 *
 ...
 */
class BIblockElementRight extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['IBLOCK_ID', 'SECTION_ID', 'ELEMENT_ID', 'RIGHT_ID', 'IS_INHERITED'], 'required'],
            [['IBLOCK_ID', 'SECTION_ID', 'ELEMENT_ID', 'RIGHT_ID'], 'integer'],
